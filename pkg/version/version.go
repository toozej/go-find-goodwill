// Package version provides build and version information for the go-find-goodwill application.
//
...
//
//	go build -ldflags "-X github.com/toozej/go-find-goodwill/pkg/version.Version=v1.0.0 \
//	  -X github.com/toozej/go-find-goodwill/pkg/version.Commit=abc123 \
//	  -X github.com/toozej/go-find-goodwill/pkg/version.Branch=main"
//
// Example usage:
//
//	import "github.com/toozej/go-find-goodwill/pkg/version"
//
...
// Build-time injection example:
//
//	go build -ldflags "-X github.com/toozej/go-find-goodwill/pkg/version.Version=v1.2.3"
var (
