// Package man provides manual page generation functionality for the go-find-goodwill application.
//
// This package creates Unix manual pages (man pages) for the go-find-goodwill CLI
...
// Example usage:
//
//	import "github.com/toozej/go-find-goodwill/pkg/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./go-find-goodwill man > go-find-goodwill.1
package man
...
// for the go-find-goodwill application. The command traverses the root command tree
...
//	// ./go-find-goodwill man > go-find-goodwill.1
//	// man ./go-find-goodwill.1
func NewManCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:                   "man",
		Short:                 "Generates go-find-goodwill's command line manpages",
		SilenceUsage:          true,
